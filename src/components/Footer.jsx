...
function Footer() {
  return (
    <footer className="bg-white w-full  ">
      <div className=" mb-8 mt-16 px-6 md:px-12 flex flex-col justify-between items-center">
        ...
        <div className="border-t border-[#606060] md:my-8 my-4 w-full "></div>

        {/* Bottom Section */}
        <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-[#606060] w-full ">
